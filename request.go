...
// For example:
//
//	req := NewRequest(config, "POST", "/repos/{user}/{repo}", "fabiotavarespr", "httpexpect")
//	// path will be "/repos/fabiotavarespr/httpexpect"
//
// Or:
//
//	req := NewRequest(config, "POST", "/repos/{user}/{repo}")
//	req.WithPath("user", "fabiotavarespr")
...
//
//	req := NewRequest(config, "POST", "/repos/{user}/{repo}")
//	req.WithPathObject(MyPath{"fabiotavarespr", "httpexpect"})
//	// path will be "/repos/fabiotavarespr/httpexpect"
//
//	req := NewRequest(config, "POST", "/repos/{user}/{repo}")
//	req.WithPathObject(map[string]string{"user": "fabiotavarespr", "repo": "httpexpect"})
//	// path will be "/repos/fabiotavarespr/httpexpect"
